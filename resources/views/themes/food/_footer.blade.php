@php
    ...
    $socialData     = $footerSections->get('social')?->config  ?? [];
...
<footer class="site-footer">
    <div class="footer-inner">
        ...
        <div class="footer-social">
            @if (!empty($socialData['instagram']))
                <a href="{{ $socialData['instagram'] }}" target="_blank" rel="noopener" aria-label="Instagram">
            ...
            @endif
            @if (!empty($socialData['facebook']))
                <a href="{{ $socialData['facebook'] }}" target="_blank" rel="noopener" aria-label="Facebook">
            ...
            @endif
            @if (!empty($socialData['tiktok']))
                <a href="{{ $socialData['tiktok'] }}" target="_blank" rel="noopener" aria-label="TikTok">
            ...
            @endif
            @if (!empty($socialData['youtube']))
                <a href="{{ $socialData['youtube'] }}" target="_blank" rel="noopener" aria-label="YouTube">
                    <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/></svg>
                </a>
            @endif
            @if (!empty($socialData['x']))
                <a href="{{ $socialData['x'] }}" target="_blank" rel="noopener" aria-label="X">
