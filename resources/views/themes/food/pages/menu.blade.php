...
<head>
    ...
    <title>Carta · {{ $site->config['business_name'] ?? $site->slug }}</title>
    @if ($site->logo_url)
    ...
    @include('themes.food._head_styles', ['site' => $site, 'fontHeading' => $fontHeading, 'fontBody' => $fontBody])
    <style>
...
<body>
@include('themes.food._nav', ['site' => $site])

<main>
    <div class="page-wrap">
        <a href="{{ route('site.show', $site->slug) }}#menu" class="page-back">← Volver</a>
    </div>
    ...
    @include('themes.food.sections.menu', [
    ...
    <div class="page-wrap" style="padding-bottom: 0;">
        <div class="owner-toolbar">
            <strong style="font-size:.875rem;">Gestionar platos adicionales</strong>
    ...
    <div class="add-service-panel" id="add-service-panel">
        ...
        <div class="add-form-grid">
            <input type="text" id="new-name" placeholder="Nombre del plato *">
            <input type="text" id="new-price" placeholder="Precio (ej: 12€)">
...
@include('themes.food._footer', ['site' => $site])
...
(function () {
    ...
    saveBtn.addEventListener('click', async () => {
        ...
        const saveUrl = "{{ route('site.more-items.update', ['slug' => $site->slug, 'sectionType' => 'menu']) }}";
