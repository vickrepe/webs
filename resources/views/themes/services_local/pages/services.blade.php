...
<body>
@include('themes.services_local._nav', ['site' => $site])
...
<main>
    ...
    @include('themes.services_local.sections.services', [
    ...
    <div class="add-service-panel" id="add-service-panel">
        ...
        <div class="add-form-grid">
            ...
            <input type="text" id="new-price" placeholder="Precio (ej: 50€)">
...
@include('themes.services_local._footer', ['site' => $site])
