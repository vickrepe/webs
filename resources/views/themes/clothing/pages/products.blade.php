...
<head>
    ...
    <title>Productos · {{ $site->config['business_name'] ?? $site->slug }}</title>
    @if ($site->logo_url)
...
<main>
    <div class="page-wrap">
        <a href="{{ route('site.show', $site->slug) }}#products" class="page-back">← Volver</a>
    </div>
    ...
    @include('themes.clothing.sections.products', [
    ...
    <div class="page-wrap" style="padding-bottom: 0;">
        <div class="owner-toolbar">
            <strong style="font-size:.875rem;">Gestionar productos adicionales</strong>
    ...
    <div class="add-service-panel" id="add-service-panel">
        ...
        <div class="add-form-grid">
            ...
            <input type="text" id="new-price" placeholder="Precio (ej: 39€)">
...
(function () {
    ...
    saveBtn.addEventListener('click', async () => {
        ...
        const saveUrl = "{{ route('site.more-items.update', ['slug' => $site->slug, 'sectionType' => 'products']) }}";
